...
class SeverityAnalyzer:
    ...
    def __init__(self):
        ...
        self.prompt_template = """你是"恋爱脑程度识别器"。仔细分析用户的恋爱脑程度，严格按照标准评分，只输出JSON格式。
            ...
            - **轻度(0-39):** 情绪焦虑、过度解读对方行为、轻度经济付出、轻度情绪依赖（如已读不回/频繁看消息等）。
            - **中度(40-69):** 较大经济付出、隐瞒关系、改变习惯、情绪沉迷严重，如关系中断舍离明显（减少社交/改变习惯/作息）、隐瞒关系、中等金额/持续型经济付出、工作/学业受影响、掌控欲苗头（查手机、定位、限制穿着/交友的“建议”）。
            - **重度(70-89):** 大额转账、重大人生决定、过度情绪沉迷、有被情感操控/pua风险、过度情绪焦虑/依赖。
                - 如大额经济风险（借贷/转账/共同负债/投资/担保等）。
                - 重大人生决策（裸辞/辍学/搬家同居/结婚/生育）在明显情绪操控下仓促做出。
                - 情感操控/PUA 明确迹象（贬低羞辱+间歇性热情、煤气灯、社会隔离、条件式关爱）。
                - 过度情绪焦虑/依赖（如频繁查看手机/消息/朋友圈/对方动态、过度解读对方行为/语言/态度。
            - **危险(90-100):** 暴力威胁、违法行为、控制人身自由、极端自我伤害想法、涉未成年、涉家暴、性行为性骚扰等。
               - 人身暴力/威胁：打骂、勒脖、限制自由、跟踪尾随、威胁伤害你/家人/宠物。
                - 性安全风险/极端情绪涉自伤他伤高风险/强迫或违法，涉未成年且存在性/经济/控制要素。
                - 多次复发或升级：重度信号短期内复现/加剧。
